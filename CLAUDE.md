...
internal/
  ...
  watch/          host-side fsnotify watcher (walker, classifier, debouncer, dispatcher, first-run suppression, pidfile + orphan detection done; lifecycle signals / detached child still open — see td)
templates/
