...
var integrationFixtures = []integrationFixture{
	{
		...
		files: []string{".frank/compose.yaml", ".env", ".env.example", ".frank/Dockerfile", ".frank/Caddyfile", ".frank/vite-server.js"},
	},
	{
		...
		files: []string{".frank/compose.yaml", ".env", ".env.example", ".frank/Dockerfile", ".frank/nginx.conf", ".frank/nginx.Dockerfile", ".frank/vite-server.js"},
	},
	{
